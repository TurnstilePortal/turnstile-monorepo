...
export async function registerTurnstileTokenContractClass(l2Client: L2Client): Promise<Fr> {
  ...
  const tokenContractClass = await getContractClassFromArtifact(TokenContractArtifact);
